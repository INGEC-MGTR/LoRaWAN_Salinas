...
int main(int argc, char* argv[])
{
    ...
    double weatherLoss = 0.0;  // Pérdidas adicionales por clima (0, 5, 10 dB)
    ...
    cmd.AddValue("weatherLoss", "Pérdidas adicionales por clima (dB)", weatherLoss);
    ...
    std::cout << "  Pérdidas climáticas: " << weatherLoss << " dB" << std::endl;
    ...
    loss->SetReference(1, 7.7 + weatherLoss);
