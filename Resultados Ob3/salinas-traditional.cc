...
int main(int argc, char* argv[])
{
    ...
    double weatherLoss = 0.0;  // NUEVO: Pérdidas climáticas (0, 5, 10 dB)
    ...
    cmd.AddValue("weatherLoss", "Pérdidas adicionales por clima (dB)", weatherLoss);  // NUEVO
    cmd.Parse(argc, argv);
    ...
    NS_LOG_INFO("Pérdidas climáticas adicionales: " << weatherLoss << " dB");  // NUEVO
    ...
    loss->SetReference(1, 7.7 + weatherLoss);  // MODIFICADO: Agregar pérdidas climáticas
